    ...
    <div className="ob-backdrop">
            ...
            {!verificationSuccess ? (
              <>
                <div className="ob-right-header">
                  ...
                  <p className="ob-sub">
                    Enter your license key to unlock Pro features on this
                    device.
                  </p>
                </div>
                ...
                <p className="ob-footnote">
                  You can register at any time from the License panel
                  in&nbsp;Settings.
                </p>
              </>
            ) : (
              ...
              <div className="ob-success-state">
                ...
                <p className="ob-success-sub">
                  License verified and bound to this device. Preparing your
                  workspace…
                </p>
      ...
      <style>{`
        ...
        .ob-shell {
          ...
          overflow: hidden;
          animation: obSlideUp 0.3s cubic-bezier(0.4, 0, 0.2, 1) both;
        }
        @keyframes obSlideUp {
